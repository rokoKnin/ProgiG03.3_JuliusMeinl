export let ScrollAreaRootCssVars = /*#__PURE__*/function (ScrollAreaRootCssVars) {
   ...
   * @type {number}
   */
  ScrollAreaRootCssVars["scrollAreaOverflowXStart"] = "--scroll-area-overflow-x-start";
  /**
   * The distance from the horizontal end edge in pixels.
   * @type {number}
   */
  ScrollAreaRootCssVars["scrollAreaOverflowXEnd"] = "--scroll-area-overflow-x-end";
  /**
   * The distance from the vertical start edge in pixels.
   * @type {number}
   */
  ScrollAreaRootCssVars["scrollAreaOverflowYStart"] = "--scroll-area-overflow-y-start";
  /**
   * The distance from the vertical end edge in pixels.
   * @type {number}
   */
  ScrollAreaRootCssVars["scrollAreaOverflowYEnd"] = "--scroll-area-overflow-y-end";
