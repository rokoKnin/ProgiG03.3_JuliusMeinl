...
export declare namespace MenuSubmenuRoot {
  interface Props extends Omit<MenuRoot.Props, 'modal' | 'openOnHover' | 'onOpenChange'> {
    /**
  ...
  interface State {}
  type ChangeEventReason = MenuRoot.ChangeEventReason;
  type ChangeEventDetails = MenuRoot.ChangeEventDetails;
}