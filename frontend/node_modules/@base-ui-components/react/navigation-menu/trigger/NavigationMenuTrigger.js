...
const NavigationMenuTrigger = exports.NavigationMenuTrigger = /*#__PURE__*/React.forwardRef(function NavigationMenuTrigger(componentProps, forwardedRef) {
  ...
  function handleActivation(event) {
    ReactDOM.flushSync(() => {
      ...
      if (value != null) {
        setValue(itemValue, (0, _createBaseUIEventDetails.createChangeEventDetails)(event.type === 'mouseenter' ? 'trigger-hover' : 'trigger-press', event.nativeEvent));
      }
    });
  }
  ...
  const defaultProps = {
    ...
    onKeyDown(event) {
      ...
      if (openHorizontal || openVertical) {
        setValue(itemValue, (0, _createBaseUIEventDetails.createChangeEventDetails)('list-navigation', event.nativeEvent));
    ...
    onBlur(event) {
      if (positionerElement && popupElement && (0, _isOutsideMenuEvent.isOutsideMenuEvent)({
        ...
        setValue(null, (0, _createBaseUIEventDetails.createChangeEventDetails)('focus-out', event.nativeEvent));
      }
    }
  };
  const {
