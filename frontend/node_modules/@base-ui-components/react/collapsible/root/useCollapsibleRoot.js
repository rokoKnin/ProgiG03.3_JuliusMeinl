...
function useCollapsibleRoot(parameters) {
  ...
  const handleTrigger = (0, _useEventCallback.useEventCallback)(event => {
    const nextOpen = !open;
    const eventDetails = (0, _createBaseUIEventDetails.createChangeEventDetails)('trigger-press', event.nativeEvent);
