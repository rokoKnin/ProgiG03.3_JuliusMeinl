  ...
  const props = (0, _mergeProps.mergeProps)(triggerProps, {
    ...
    onFocus(event) {
      ...
      if (open && alignItemWithTriggerActiveRef.current) {
        setOpen(false, (0, _createBaseUIEventDetails.createChangeEventDetails)('focus-out', event.nativeEvent));
      }
    ...
    onMouseDown(event) {
      ...
      function handleMouseUp(mouseEvent) {
        ...
        setOpen(false, (0, _createBaseUIEventDetails.createChangeEventDetails)('cancel-open', mouseEvent));
      }
