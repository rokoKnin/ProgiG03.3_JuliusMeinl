...
const SelectPopup = exports.SelectPopup = /*#__PURE__*/React.forwardRef(function SelectPopup(componentProps, forwardedRef) {
  ...
  const handleScroll = (0, _useEventCallback.useEventCallback)(scroller => {
  ...
  React.useEffect(() => {
    ...
    function handleResize(event) {
      setOpen(false, (0, _createBaseUIEventDetails.createChangeEventDetails)('window-resize', event));
    }
