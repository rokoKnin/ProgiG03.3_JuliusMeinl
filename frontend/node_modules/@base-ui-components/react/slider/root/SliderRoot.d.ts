...
export declare namespace SliderRoot {
  ...
  interface Props<Value extends number | readonly number[] = number | readonly number[]> extends BaseUIComponentProps<'div', State> {
     ...
     */
    onValueChange?: (value: Value extends number ? number : Value, eventDetails: ChangeEventDetails) => void;
    /**
     * Callback function that is fired when the `pointerup` is triggered.
     * **Warning**: This is a generic event not a change event.
     */
    onValueCommitted?: (value: Value extends number ? number : Value, eventDetails: CommitEventDetails) => void;
  }
  type ChangeEventReason = 'none';
  type ChangeEventDetails = BaseUIChangeEventDetails<ChangeEventReason, {
    activeThumbIndex: number;
  }>;
  type CommitEventReason = 'none';
