...
const MenuPositioner = exports.MenuPositioner = /*#__PURE__*/React.forwardRef(function MenuPositioner(componentProps, forwardedRef) {
    ...
    function onMenuOpenChange(details) {
      if (details.open) {
        ...
        if (details.nodeId !== nodeId && details.parentNodeId === parentNodeId) {
          setOpen(false, (0, _createBaseUIEventDetails.createChangeEventDetails)('sibling-open'));
        }
  ...
  React.useEffect(() => {
    ...
    function onParentClose(details) {
      ...
      setOpen(false, (0, _createBaseUIEventDetails.createChangeEventDetails)(reason));
    }
