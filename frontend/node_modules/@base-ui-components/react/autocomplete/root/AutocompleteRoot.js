...
function AutocompleteRoot(props) {
  ...
  const handleItemHighlighted = (0, _useEventCallback.useEventCallback)((highlightedValue, eventDetails) => {
    ...
    if (enableInline) {
      if (highlightedValue == null) {
        ...
        setInlineOverlay((0, _resolveValueLabel.stringifyAsLabel)(highlightedValue, itemToStringValue));
      }
    } else {
      setInlineOverlay('');
    }
