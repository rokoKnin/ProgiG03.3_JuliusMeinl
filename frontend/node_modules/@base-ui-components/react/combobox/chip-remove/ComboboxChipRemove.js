  ...
  const element = (0, _useRenderElement.useRenderElement)('button', componentProps, {
    ...
    props: [{
      ...
      onClick(event) {
        ...
        const eventDetails = (0, _createBaseUIEventDetails.createChangeEventDetails)('chip-remove-press', event.nativeEvent);
        ...
        const removedIndex = (0, _itemEquality.findItemIndex)(valuesRef.current, removedItem, isItemEqualToValue);
