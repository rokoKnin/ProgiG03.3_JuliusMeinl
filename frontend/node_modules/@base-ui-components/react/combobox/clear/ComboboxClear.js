  ...
  const element = (0, _useRenderElement.useRenderElement)('button', componentProps, {
    ...
    props: [{
      ...
      onClick(event) {
        ...
        store.state.setInputValue('', (0, _createBaseUIEventDetails.createChangeEventDetails)('clear-press', event.nativeEvent));
        if (selectionMode !== 'none') {
          store.state.setSelectedValue(Array.isArray(selectedValue) ? [] : null, (0, _createBaseUIEventDetails.createChangeEventDetails)('clear-press', event.nativeEvent));
