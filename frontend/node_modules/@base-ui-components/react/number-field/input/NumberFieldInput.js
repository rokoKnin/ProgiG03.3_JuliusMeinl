  ...
  const inputProps = {
    ...
    onBlur(event) {
      ...
      if (inputValue.trim() === '') {
        ...
        onValueCommitted(null, (0, _createBaseUIEventDetails.createGenericEventDetails)('none', event.nativeEvent));
        return;
      }
      ...
      const nextEventDetails = (0, _createBaseUIEventDetails.createGenericEventDetails)('none', event.nativeEvent);
    ...
    onKeyDown(event) {
      ...
      const details = (0, _createBaseUIEventDetails.createChangeEventDetails)('none', nativeEvent);
