...
function useFocus(context, props = {}) {
  ...
  const reference = React.useMemo(() => ({
    ...
    onFocus(event) {
      ...
      onOpenChange(true, (0, _createBaseUIEventDetails.createChangeEventDetails)('trigger-focus', event.nativeEvent));
    },
    onBlur(event) {
      blockFocusRef.current = false;
      ...
      timeout.start(0, () => {
        ...
        onOpenChange(false, (0, _createBaseUIEventDetails.createChangeEventDetails)('trigger-focus', nativeEvent));
      });
    }
