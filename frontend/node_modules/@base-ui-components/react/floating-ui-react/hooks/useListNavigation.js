...
function useListNavigation(context, props) {
  ...
  const commonOnKeyDown = (0, _useEventCallback.useEventCallback)(event => {
    ...
    if (nested && isCrossOrientationCloseKey(event.key, orientation, rtl, cols)) {
      ...
      onOpenChange(false, (0, _createBaseUIEventDetails.createChangeEventDetails)('list-navigation', event.nativeEvent));
        ...
        if (nested) {
          if (isParentCrossOpenKey) {
            ...
            if (open) {
              ...
              onOpenChange(true, (0, _createBaseUIEventDetails.createChangeEventDetails)('list-navigation', event.nativeEvent));
            }
          }
          return undefined;
        }
