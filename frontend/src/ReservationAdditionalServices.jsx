      ...
      <Box sx={{width:"100%",display:"flex",flexDirection:"column", gap:"1rem"}}>
            ...
            <Button variant="contained" color="primary" onClick={handleAdd}>+</Button>
              ...
              {lista.map((rez)=>
                (
                 <Box>
                  <Box sx={{display:"flex",justifyContent:"space-around"}}>{rez.format("DD.MM.YYYY")} <Button sx={{color:"white",backgroundColor:"red",borderRadius:"15px"}} onClick={handleDelete}>x</Button></Box>
                   </Box>
                )
              )}
